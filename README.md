...
<p align="center">
  ...
  <a href="https://pawankumar.dorik.io/"><img src="https://img.shields.io/badge/Portfolio-00F2FE?style=for-the-badge&logo=google-chrome&logoColor=black" alt="Portfolio"/></a>
...
<div align="center" style="background: #0b0f19; border-radius: 12px; padding: 25px; border: 1px solid #1e293b; color: #f8fafc;">
  ...
  <p style="margin-top: 15px; color: #f1f5f9; font-size: 16px; font-weight: 600;">
...
<table width="100%">
  ...
  <tr style="border: none;">
    <td width="28%" valign="top" style="border: none; border-right: 2px solid #7f5aeb; text-align: right; padding-right: 15px;">
      <span style="color: #00f2fe; font-family: monospace; font-size: 14px; font-weight: 700;">Mar 2026 - Present</span><br/>
      <span style="background: rgba(0, 242, 254, 0.1); color: #00f2fe; padding: 2px 8px; border-radius: 10px; font-size: 10px; font-weight: 700; border: 1px solid rgba(0, 242, 254, 0.3); display: inline-block; margin-top: 5px;">ACTIVE CORE</span>
    </td>
  ...
  <tr style="border: none;">
    <td width="28%" valign="top" style="border: none; border-right: 2px solid #ff0844; text-align: right; padding-right: 15px;">
      <span style="color: #ff0844; font-family: monospace; font-size: 14px; font-weight: 700;">Dec 2025 - Mar 2026</span><br/>
      <span style="background: rgba(255, 8, 68, 0.1); color: #ff0844; padding: 2px 8px; border-radius: 10px; font-size: 10px; font-weight: 700; border: 1px solid rgba(255, 8, 68, 0.3); display: inline-block; margin-top: 5px;">SENIOR ROLE</span>
    </td>
    <td width="72%" valign="top" style="border: none; padding-left: 15px; padding-bottom: 25px;">
      <h3 style="margin: 0; color: #ffffff; font-size: 20px;">Senior AI Engineer</h3>
      <strong style="color: #ff0844; font-size: 16px;">Primesource Consulting LLP</strong> · <span style="color: #586799; font-size: 13px;">Voice AI Operations</span><br/><br/>
      <img src="https://img.shields.io/badge/Voice%20AI-STT%20%2F%20TTS-00f2fe?style=flat-square" alt="Voice AI"/> <img src="https://img.shields.io/badge/Latency-Optimized-7f5aeb?style=flat-square" alt="Latency Optimized"/>
      <ul style="margin-top: 10px; color: #94a3b8; line-height: 1.5;">
  ...
  <tr style="border: none;">
    <td width="28%" valign="top" style="border: none; border-right: 2px solid #7f5aeb; text-align: right; padding-right: 15px;">
      <span style="color: #7f5aeb; font-family: monospace; font-size: 14px; font-weight: 700;">Oct 2024 - Nov 2025</span><br/>
      <span style="background: rgba(127, 90, 235, 0.1); color: #7f5aeb; padding: 2px 8px; border-radius: 10px; font-size: 10px; font-weight: 700; border: 1px solid rgba(127, 90, 235, 0.3); display: inline-block; margin-top: 5px;">QUANT AI</span>
    </td>
    <td width="72%" valign="top" style="border: none; padding-left: 15px; padding-bottom: 25px;">
      <h3 style="margin: 0; color: #ffffff; font-size: 20px;">AI Engineer</h3>
      <strong style="color: #7f5aeb; font-size: 16px;">FinSocial Digital Systems</strong> · <span style="color: #586799; font-size: 13px;">Newark, DE (Remote)</span><br/><br/>
      <img src="https://img.shields.io/badge/Multi--Agent-LLM%20Frameworks-ff0844?style=flat-square" alt="Multi-Agent"/> <img src="https://img.shields.io/badge/Trading-Automation-00f2fe?style=flat-square" alt="Trading Automation"/>
      <ul style="margin-top: 10px; color: #94a3b8; line-height: 1.5;">
  ...
  <tr style="border: none;">
    <td width="28%" valign="top" style="border: none; border-right: 2px solid #00f2fe; text-align: right; padding-right: 15px;">
      <span style="color: #00f2fe; font-family: monospace; font-size: 14px; font-weight: 700;">Dec 2023 - Aug 2024</span><br/>
      <span style="background: rgba(0, 242, 254, 0.1); color: #00f2fe; padding: 2px 8px; border-radius: 10px; font-size: 10px; font-weight: 700; border: 1px solid rgba(0, 242, 254, 0.3); display: inline-block; margin-top: 5px;">ALGO SYSTEMS</span>
    </td>
    <td width="72%" valign="top" style="border: none; padding-left: 15px; padding-bottom: 5px;">
      ...
      <strong style="color: #00f2fe; font-size: 16px;">BytEquity</strong> · <span style="color: #586799; font-size: 13px;">Noida, India</span><br/><br/>
      <img src="https://img.shields.io/badge/Strategy-8%20Deployed-ff0844?style=flat-square" alt="8 Deployed Strategies"/> <img src="https://img.shields.io/badge/Efficiency-%2B25%25-00f2fe?style=flat-square" alt="+25% Efficiency"/>
      <ul style="margin-top: 10px; color: #94a3b8; line-height: 1.5;">
