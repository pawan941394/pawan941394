...
<div style="display: flex; gap: 20px; margin-bottom: 30px;">
  <div style="flex: 1;">
    <h3>🌿 Orga Plants | Python Developer Intern | Apr - Oct 2022</h3>
    <ul>
      <li>Optimized data handling with web scraping for user payments and orders</li>
      <li>Developed UI and backend with Django, reducing page load times by 30%</li>
    </ul>
  </div>

  <div style="flex: 1;">
    <h3>🏥 Care Team Private Limited | Python Developer Intern | Jan - Mar 2022</h3>
    <ul>
